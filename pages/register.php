    ...
    <div class="container container--with-sidebar">
      ...
      <div class="content">
        ...
        <main class="content__main">
          ...
          <form class="form" action="signup.php" method="post" autocomplete="off" enctype="multipart/form-data">
            <div class="form__row">
            ...
            <div class="form__row">
              <label class="form__label" for="password_confirm">Подтвердите пароль <sup>*</sup></label>

              <input class="form__input" type="password" name="password_confirm" id="password" value="" placeholder="Введите пароль">
            </div>
            ...
            <div class="form__row">
              <label class="form__label" for="login">Логин <sup>*</sup></label>

              <input class="form__input" type="text" name="login" id="login" value="" placeholder="Введите логин">
            </div>

            <div class="form__row">
              <label class="form__label" for="avatar">Аватар <sup>*</sup></label>

              <input class="form__input" type="file" name="avatar" id="avatar" value="" placeholder="аватар">
            </div>
